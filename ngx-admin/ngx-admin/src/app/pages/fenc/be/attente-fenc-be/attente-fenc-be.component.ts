...
@Component({
  selector: 'ngx-attente-fenc-be',
  templateUrl: './attente-fenc-be.component.html',
  styleUrls: ['./attente-fenc-be.component.scss']
})
export class AttenteFencBeComponent implements OnInit {

  anomalieBe:any

  constructor(private router:Router,private anomalieService:AnomalieService) {
    this.anomalieService.getAnomalieEnAttenteByService("bureauEtude").subscribe(data => {
