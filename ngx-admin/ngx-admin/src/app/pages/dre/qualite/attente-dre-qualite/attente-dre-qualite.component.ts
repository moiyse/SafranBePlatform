...
@Component({
  selector: 'ngx-attente-dre-qualite',
  templateUrl: './attente-dre-qualite.component.html',
  styleUrls: ['./attente-dre-qualite.component.scss']
})
export class AttenteDreQualiteComponent implements OnInit {
  ...
  constructor(private router:Router,private service: SmartTableData,private anomalieService:AnomalieService) {
    ...
    this.anomalieService.getDreEnAttenteByService("qualiteProduit").subscribe(data => {
      this.anomalieQualite = data
      this.source.load(this.anomalieQualite)
    })
  }
    ...
    columns: {
      ...
      buttonImprime: {
        ...
        onComponentInitFunction(instance) {
          const buttonType = "OuvrirDREQualite"
