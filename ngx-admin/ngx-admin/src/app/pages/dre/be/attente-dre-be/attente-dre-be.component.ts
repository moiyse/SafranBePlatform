...
@Component({
  selector: 'ngx-attente-dre-be',
  templateUrl: './attente-dre-be.component.html',
  styleUrls: ['./attente-dre-be.component.scss']
})
export class AttenteDreBeComponent implements OnInit {
  ...
  constructor(private router:Router,private service: SmartTableData,private anomalieService:AnomalieService) {
    ...
    this.anomalieService.getDreEnAttenteByService("be").subscribe(data => {
